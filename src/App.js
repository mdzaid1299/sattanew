                  ...
                  <div className="row" style={{ "margin-bottom": "0px" }}>
                    ...
                    <div className="col-sm-6">
                      <div className="input-group mb15">
                        <input
                          type="button"
                          onclick="if (!window.__cfRLUnblockHandlers) return false; printDiv('printableArea')"
                          defaultValue="Print Chart"
                          className="btn btn-warning"
                          data-cf-modified-b90160480376af563f760fd1-
                        />
                        <input
                          type="button"
                ...
                <div>
                  ...
                  >
                    ...
                    <small>
                      ...
                      Rules The Site is Only For Entertainment Purposes. <br />{" "}
                      The Site Does Not Promote any Betting Activity. People
                      From Countries Where Gambling is Banned Should Block Our
                      Site immediately.
                      <br /> If you are Not Agreed/satisfied With Our Terms
                      &amp; Conditions Please Quit Right Now. PLAYBAZAAR.XYZ All
...
function Header() {
  return (
    <div className="text-center">
      <img src="playbazaar.png" alt="Play Bazaar" style={{ width: "30%" }} />
      <h4>Monthly Result Chart</h4>
      <h4 id="liveDatetime"></h4>
    </div>
  );
}
  ...
  return (
    <div className="row" style={{ marginBottom: "0px" }}>
      <form action="index.php" id="showResult" method="post">
        ...
        <div className="col-sm-2">
          <select name="dd_year" id="dd_year" className="form-control">
            <option value="2020">2020</option>
            {/* ... other years */}
  ...
  return (
    <div className="table-responsive">
      <table
        ...
        style={{ fontSize: "14px", color: "#6C7682" }}
      >
        <thead>
          <tr>
            <th>Game</th>
...
function Footer() {
  return (
    <footer className="panel-footer text-center">
      <small>
        Disclaimer: PLAYBAZAAR.XYZ : We Follow All Countries Rules. The Site is
